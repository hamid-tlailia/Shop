    ...
    <li>
      <a class="dropdown-item" href="searsh.php"><span class="fa-li pe-2"><i
        ...
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link text-primary fw-bold text-decoration-underline" aria-current="page" href="about.php">About us</a>
          </li>
          <li class="nav-item">
  ...
  <!-- header end -->
    ...
    <div class="container-fluid p-3 bg-white">
      <div class="row p-3  " style="border-radius: 0 0 500px 500px;background-color: azure;">
        <h3 class="text-muted text-center text-decoration-underline mb-3">About Us</h3>
        <div class="note note-warning">
          <strong>How we are ? :</strong>
          <p class="lead">
        ...
        <hr>
        <h3 class="text-muted text-center text-decoration-underline">Our services</h3>
        <div class="row">
                ...
                <div class="card">
                  <div class="card-body">
                    <blockquote class="blockquote blockquote-custom bg-white px-3 pt-4">
                      ...
                      " <a href="#" class="text-info">@FC company</a>."
                      </p>
                      <footer class="blockquote-footer pt-4 mt-4 border-top">
                        Great team greeting in
                        <cite title="Source Title">FC</cite>
                      </footer>
                    </blockquote>
                  </div>
                </div>
        ...
        <hr>
        <h3 class="text-muted text-center text-decoration-underline">Our Team</h3>
        <div class="row p-3 ">
          <div class="col-sm-12 col-lg-4 col-md-6">
            <div class="container">
              <section class="mx-auto my-5" style="max-width: 23rem;">
                <div class="card testimonial-card mt-2 mb-3">
                  ...
                  <div class="avatar mx-auto white">
                    <img src="images/avatar2.jpg" class="rounded-circle img-fluid" alt="woman avatar">
                  </div>
                  <div class="card-body text-center">
                    <h4 class="card-title font-weight-bold">Hamid Tlailia</h4>
                    <hr>
                    <p><i class="fas fa-quote-left"></i> Admin of FC company </p>
                  </div>
                </div>
            ...
            <div class="container">
              <section class="mx-auto my-5" style="max-width: 23rem;">
                <div class="card testimonial-card mt-2 mb-3">
                  ...
                  <div class="card-body text-center">
                    <h4 class="card-title font-weight-bold">Aymen Tahri</h4>
                    <hr>
                    <p><i class="fas fa-quote-left"></i> Super responsable of FC company</p>
                  </div>
                </div>
            ...
            <div class="container">
              <section class="mx-auto my-5" style="max-width: 23rem;">
                <div class="card testimonial-card mt-2 mb-3">
                  ...
                  <div class="card-body text-center">
                    <h4 class="card-title font-weight-bold">Flour Red</h4>
                    <hr>
                    <p><i class="fas fa-quote-left"></i> Admin of FC projects</p>
                  </div>
                </div>
