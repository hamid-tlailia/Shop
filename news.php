      ...
      <a class="dropdown-item" href="searsh.php"><span class="fa-li pe-2"><i
        ...
        <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
          <li class="nav-item active">
            <a class="nav-link text-primary fw-bold text-decoration-underline" aria-current="page" href="news.php">News</a>
          </li>
          <li class="nav-item">
...
?>
  ...
  <!-- header end -->
  <!-- content start -->
<div class="container-fluid p-3 pt-3 mt-2  mb-2 bg-white bg-image" style="pointer-events: none;z-index:-2">
<div class="mask">
  <div class="content text-center">COMING SOON</div>
</div>
  <div class="row p-5 shadow-1-strong">
    <h3 class="text-muted text-center text-decoration-underline mb-4 shadow-2-strong p-3 bg-light" style="margin-top: -10vh;">Latest News</h3>
   <div class="row  pe-0 border border-dark text-light fw-bold" >
   <div class="col-lg-4 p-3 alert-white" >
          <img src="images/Blue_Tshirt.png" alt="promo" class="img-fluid">
        </div>
    <div class="col-lg-8 p-3 " style="background-color: rgba(159, 130, 238, 0.26);">
      <p class="lead">
        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Accusantium expedita 
        dicta tempore reprehenderit consectetur ipsum at necessitatibus! Esse, asperiores.
         Aliquam corporis illo in doloribus sunt dolores amet maiores aspernatur ab.
      </p>
      <h2 class="text-warning lead fs-3 mb-3" >
        Promotion from : 
        <span class="text-danger p-2 shadow-1-strong mb-5">DD/MM/YYYY</span>
         <i class="fas fa-arrow-alt-circle-right  mb-5 mt-5"></i>
          <span class="text-danger mt-5 p-2 shadow-1-strong">DD/MM/YYYY</span>
        </h2>
      <div class="container">
        <button class="btn btn-dark  anim-btn" >Get Now</button>
        <hr>
        <p class="lead text-decoration-underline text-muted">Share with :</p> <br>
        <div class=" d-flex flex-column flex-lg-row flex-md-row justify-content-start justify-items-start">
          <!-- Facebook -->
    <a class="btn btn-primary text-center mb-2 text-white me-3" style="color: #3b5998;" href="#!" role="button">
      <i class="fab fa-facebook-f  "></i>
    </a>
    
    <!-- Twitter -->
    <a class="btn btn-info text-center mb-2 text-white me-3" style="color: #55acee;" href="#!" role="button">
      <i class="fab fa-twitter  "></i>
    </a>
    
    <!-- Google -->
    <a class="btn btn-danger text-center mb-2 text-white me-3" style="color: #dd4b39;" href="#!" role="button">
      <i class="fab fa-google "></i>
    </a>
    
    <!-- Instagram -->
    <a class="btn btn-primary mb-2 me-3" style="background-color: #ac2bac;" href="#!" role="button">
  ...
  <hr>
  <h3 class="text-muted text-center text-decoration-underline mb-4 mt-5" style="margin-top: -10vh;">Black Friday</h3>
  <div class="row">
   <div class="col-lg-6">
      ...
      <div class="row g-0">
        <div class="col-md-4">
          <img
            ...
            alt="Trendy Pants and Shoes"
            class="img-fluid rounded-start"
            style="height: 100%;padding:5px;width: 120%;"
          />
        </div>
        <div class="col-md-8">
          <div class="card-body">
            <h5 class="card-title">Next Promo</h5>
            <p class="card-text">
              This is a wider card with supporting text below as a natural lead-in to
              additional content. This content is a little bit longer.
            </p>
